...
private:
	...
	BinarySearchTree* binarySearchTree;						/**< BST for searching & sorting in the cache. */
...
public:
	...
	CacheManager(int myMaxCacheSize, int myHashTableSize) {
		/*std::cout << "before IF stmt -> MaxCacheSize: " << myMaxCacheSize << " and myHashTableSize: " << myHashTableSize << std::endl;
		...
		std::cout << "after IF stmt -> MaxCacheSize: " << myMaxCacheSize << " and myHashTableSize: " << myHashTableSize << std::endl;
		*/
